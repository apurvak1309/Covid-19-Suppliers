    ...
    public void AddData() {
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (isinserted = true) {
                    Toast.makeText(DoctorRegistration.this, "Data inserted", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(DoctorRegistration.this, "Data not inserted", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
